...
public class TrendingResponse implements Serializable, Parcelable
{
    ...
    public final static Creator<TrendingResponse> CREATOR = new Creator<TrendingResponse>() {
        ...
        public TrendingResponse[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = -5910961549895734683L;

    protected TrendingResponse(android.os.Parcel in) {
        this.page = ((Integer) in.readValue((Integer.class.getClassLoader())));
        in.readList(this.results, (com.example.tmdb.data.model.Result.class.getClassLoader()));
