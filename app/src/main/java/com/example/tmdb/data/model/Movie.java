...
public class Movie implements Serializable, Parcelable
{
    ...
    public final static Creator<Movie> CREATOR = new Creator<Movie>() {
        ...
        public Movie[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = -9213821977396359457L;
    ...
    protected Movie(android.os.Parcel in) {
        ...
        in.readList(this.productionCompanies, (com.example.tmdb.data.model.ProductionCompany.class.getClassLoader()));
        in.readList(this.productionCountries, (com.example.tmdb.data.model.ProductionCountry.class.getClassLoader()));
        this.releaseDate = ((String) in.readValue((String.class.getClassLoader())));
        this.revenue = ((Integer) in.readValue((Integer.class.getClassLoader())));
        this.runtime = ((Integer) in.readValue((Integer.class.getClassLoader())));
        in.readList(this.spokenLanguages, (com.example.tmdb.data.model.SpokenLanguage.class.getClassLoader()));
